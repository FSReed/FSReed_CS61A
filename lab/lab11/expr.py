...
class CallExpr(Expr):
    ...
    def eval(self, env):
        ...
        arguments = [element.eval(env) for element in self.operands]
        return operator_value.apply(arguments)
...
class LambdaFunction(Value):
    ...
    def apply(self, arguments):
        ...
        new_parameters = list(zip(self.parameters, arguments))
        for pair in new_parameters:
